	...
	return (
		<nav className="My-Order-Nav">
			...
			<div className={`Order-Menu ${c_tab("type=failed")}`}>
                <Link to="/account/myorder?list=auction&type=failed" className="menu-link">Canceled</Link>
			</div>
		</nav>
	)
}
...
export const MyBidNav = () =>{
	...
	return (
		<nav className="My-Order-Nav">
			...
			<div className={`Order-Menu ${c_tab("type=failed")}`}>
                <Link to="/account/myorder?list=bid&type=failed" className="menu-link">Canceled</Link>
			</div>
		</nav>
	)
}
